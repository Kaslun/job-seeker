    ...
    <div style={{ minHeight: "100vh", background: "var(--paper)" }}>
      ...
      <div style={{ padding: "24px 60px 60px", maxWidth: 1080, margin: "0 auto" }}>
        <div className="row between" style={{ marginBottom: 18 }}>
          <Link href="/feed" className="row gap-2 mono dim" style={{ fontSize: 12, cursor: "pointer" }}>
            ← back to feed
          </Link>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1.7fr 1fr", gap: 36 }}>
          ...
          <aside className="col" style={{ gap: 16, position: "sticky", top: 90, alignSelf: "flex-start" }}>
            <JobActions job={job} />
          </aside>
        </div>
      </div>
